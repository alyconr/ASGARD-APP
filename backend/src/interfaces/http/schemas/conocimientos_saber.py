"""HTTP schemas for SABER knowledge CRUD endpoints."""
...
class ConocimientoSaberRequest(BaseModel):
    """Input accepted when creating or updating a SABER knowledge item."""
...
class ConocimientoSaberResponse(BaseModel):
    """SABER knowledge representation returned to the frontend."""
...
class ConocimientoSaberListResponse(BaseModel):
    ...
    competencia_id: uuid.UUID
    conocimientos: list[ConocimientoSaberResponse]


class ConocimientoSaberDeleteResponse(BaseModel):
