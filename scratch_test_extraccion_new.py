        ...
        text_extractor=FakeTextExtractor(
            "\n".join(
                [
                    ...
                    "3. Contenidos curriculares de la competencia",
                    "Codigo: 220501096",
                    "Denominacion: Construir software de acuerdo con requisitos",
                    "Resultados de aprendizaje",
                    "Validar la solucion de software",
...
async def test_extract_program_pdf_reads_complete_sections() -> None:
        ...
        text_extractor=FakeTextExtractor(
            "\n".join(
                [
                    ...
                    "3. Contenidos curriculares de la competencia",
                    "Codigo: 220501096",
                    "Denominacion: Analizar requisitos del cliente",
                    "Resultados de aprendizaje",
                    ...
                    "3. Contenidos curriculares de la competencia",
                    "Codigo: 220501097",
                    "Denominacion: Atender incidencias del software",
                ],
            ),
        ),
    )
    ...
    assert comp2.denominacion.valor == "Atender incidencias del software"
...
async def test_extract_program_pdf_no_legible_skips_storage_read() -> None:
    ...
    assert result.estructura_curricular.estado is EstadoCampo.PENDIENTE
